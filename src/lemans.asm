...
!ifndef USE_JOYSTICK { USE_JOYSTICK = 0 }           ;Set it to 1 to use Joystick  instead of Paddle
!ifndef USE_RUMBLE { USE_RUMBLE = 0 }               ;Set it to 1 to enable Rumble when car
                                                    ; hits the shoulder
!ifndef USE_PRG { USE_PRG = 0 }                     ;Generate a .prg instead of a .crt
                                                    ; Original is cartridge
!ifndef USE_FIX_MISSPELL { USE_FIX_MISSPELL = 0 }   ;Fix "BOUNS" -> "BONUS"
...
TITLE_MSG
        ...
        !scr         " by     "
        !scr "   commodore    "
        !scr "electronics ltd",$1E             ; .
        !scr "      and       "
        !scr " hal laboratory "
        !scr "  push ",$1D,$06,$22,$1D," or  " ; 'F1'
!if USE_JOYSTICK=0 {
        !scr "button on paddle"
} else {
        !scr " button on joy",$22," "
}
        !scr "    to start    "
        !scr "                "
...
._L01   STA COLOR_RAM+1,Y
        ...
        ; Setup Screen ptr
        LDA ZP_SHOULDER_LEFT_IDX
        LSR                             ;ZP_SHOULDER_LEFT_IDX /= 4
        LSR                             ;Since we draw 4 char shoulders
...
!if USE_PRG = 1 {
        ...
        * = $F800
        ...
        !binary "src/charset-f800-f97f.bin"         ;Chars 00-47
        !binary "src/sprites-f980-f9ff.bin"         ;Frames 230-231
        !binary "src/charset-fa00-fcbf.bin"         ;Chars 64-151
        !binary "src/sprites-fcc0-ffbf.bin"         ;Frames 243-254
